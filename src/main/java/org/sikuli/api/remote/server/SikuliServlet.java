...
public class SikuliServlet extends HttpServlet {
  public static final String SESSIONS_KEY = SikuliServlet.class.getName() + ".sessions";
  ...
  @VisibleForTesting
  SikuliServlet(Supplier<DriverSessions> sessionsSupplier) {
  ...
  protected void handleRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      mappings.handleRequest(req, res, request);
